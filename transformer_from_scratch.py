...
#     3 - self attention score - for each token three vector will be there : qurey, key,value 
#     4 - scaled dot product: calculate attention score and then apply softmax to normalize
#     5 - output = softmax(scaled attention score).v   -> v = value vector 
...
#multi head attention : splits input into multiple heads, applies self attention to each head, and then concatenates the outputs
